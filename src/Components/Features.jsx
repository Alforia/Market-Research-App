...
const Features = () => {
  ...
  return (
    <div id='features' className='grid lg:grid-cols-2 grid-cols-1-reverse 2xl:px-96 items-center gap-12 md:gap-32 py-24 sm:flex-row justify-center px-40 pb-36'>
      <div
        ref={imgRef}
